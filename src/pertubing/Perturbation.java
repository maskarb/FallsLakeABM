...
public class Perturbation {
  ...
  public Perturbation(
      final double shiftFactor, final double quantileProbability, final DataList dataList) {

    double v = quantileProbability;

    if (quantileProbability == 1) v = 0.999999995;
  ...
  public double workflow() {
    ...
    // inverseCumulativeProbability = quantile function => returns quantile at probOfQuantile (the
  ...
  public static void main(String[] args) {
    ...
    double[] value = {
      816, 1884, 1039, 340, 1919, 784, 340, 1310, 2084, 1174, 1868, 784, 843, 1682, 1151, 3006,
