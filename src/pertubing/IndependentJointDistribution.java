...
public class IndependentJointDistribution {
  ...
  public IndependentJointDistribution(
      double meanFunc1, double meanFunc2, double stDvFunc1, double stDvFunc2) {
  ...
  public double sampleUsingGamma(double estimatedValFunc1) {
    ...
    GammaDistribution ex1 =
        new GammaDistribution(
            (meanFunc1 * meanFunc1) / (stDvFun1 * stDvFun1), meanFunc1 / (stDvFun1 * stDvFun1));

    GammaDistribution ex2 =
        new GammaDistribution(
            (meanFunc2 * meanFunc2) / (stDvFun2 * stDvFun2), meanFunc2 / (stDvFun2 * stDvFun2));
  ...
  public static void main(String[] args) {
    ...
    double[][] data2 = {
      {
        0.047619048, 52.73987935,
      },
      {
        0.095238095, 71.54160933,
      },
      {
        0.142857143, 106.0382066,
      },
      {
        0.19047619, 125.9778778,
      },
      {
        0.238095238, 148.7178317,
      },
      {
        0.285714286, 165.7184402,
      },
      {
        0.333333333, 238.8090519,
      },
      {
        0.380952381, 244.2605078,
      },
      {
        0.428571429, 268.4629014,
      },
      {
        0.476190476, 315.87387,
      },
      {
        0.523809524, 387.3319427,
      },
      {
        0.571428571, 468.3234345,
      },
      {
        0.619047619, 615.7390245,
      },
      {
        0.666666667, 667.4146472,
      },
      {
        0.714285714, 699.8776352,
      },
      {
        0.761904762, 717.9256707,
      },
      {
        0.80952381, 1004.851599,
      },
      {
        0.857142857, 1121.229125,
      },
      {
        0.904761905, 1483.170432,
      },
      {0.952380952, 2767.999274}
    };
