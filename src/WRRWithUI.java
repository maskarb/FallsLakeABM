...
public class WRRWithUI extends GUIState {
  ...
  public WRRWithUI(
      int runNum, double shiftFac, String climate, boolean r, boolean d, double[] per, int z) {
  ...
  public static void main(String[] args) {
    ...
    WRRWithUI vid =
        new WRRWithUI(
            0, 0.1, climate, isRetrofitting, isDroughtRestriction, reductionPercentages, 1);
  ...
  public void setupPortrayals() {
    ...
    cityPortrayal.setPortrayalForAll(
        new OvalPortrayal2D() {
