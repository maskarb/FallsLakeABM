...
public class FallsLake extends Reservoir implements Steppable {
  ...
  public static HashMap<Integer, ArrayList<Double>> finalResultMap =
      new HashMap<Integer, ArrayList<Double>>();

  public FallsLake(
      boolean isReleaseModel,
      double initialStorage,
      double elevation,
      double lowestStorage,
  ...
  public void step(SimState state) {
    ...
    */
    ...
    if (time == endTime - 1) {
      ...
      if (nonzerodeficit == 0) { // if there are no deficits
        ...
        sustainabilityindex =
            Math.pow(
                reliability
                    * resilience
                    * (1 - vulnerability / averageDemand)
                    * (1 - maxDeficit / averageDemand),
                .25);
        ...
        if ((vulnerability > averageDemand) == (maxDeficit > averageDemand)) {
          sustainabilityindex =
              Math.pow(
                  reliability
                      * resilience
      ...
      System.out.println("sustainabilityindex:........ " + sustainabilityindex);
      System.out.println("vulnerability/averageDemand: " + vulnerability / averageDemand);
